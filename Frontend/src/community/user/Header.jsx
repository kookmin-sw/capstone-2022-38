...
const ProfileHeader = (props) => {
    ...
    return (
        ...
        <br/>
        <span style={{fontFamily:"var(--font-family",marginTop:"0.5em"}}>
    ...
    <div className="modal-content">
      ...
      <input className="form-control input-data" 
      name="username" placeholder="Username" 
      onChange={formik.handleChange} value={formik.values.username} />

      <input type="email" className="form-control my-2 input-data" 
      name="email" placeholder="Email" 
      onChange={formik.handleChange} value={formik.values.email} />

      <input type="text" 
      className="form-control my-2 input-data" name="bio" placeholder="Bio"
      onChange={formik.handleChange} value={formik.values.bio} />

      <input type="file" className="input-file" accept="img/*" name="avatar" placeholder="Avatar" 
